...
G4FilePath   = "/eos/user/l/ldamenti/ForkTest/geant4MaterialFile.root"
ActsFilePath = "/eos/user/l/ldamenti/ForkTest/Acts_MatTracks_forValidation_diffG4File.root"
...
# The file records
fileRecords = [ 
    FileRecord(G4FilePath,   "material-tracks", "Geant4", "blue", 3),
    FileRecord(ActsFilePath, "material-tracks", "Acts",   "orange", 4),
]

# The plot records
plotRecords = [
    PlotRecord("v_eta", "t_X0", (-4.0, 4.0), 80, "η", "ActsMatMapsValidation_tX0_vs_eta.svg"),
    PlotRecord("v_phi", "t_X0", (-math.pi, math.pi), 72, "φ", "ActsMatMapsValidation_tX0_vs_phi.svg"),
]
...
for pr in plotRecords:
    ...
    for ifr, fr in enumerate(fileRecords):
        ...
        n_entries = min(len(x_arr), len(y_arr))
        for iv in range(n_entries):
