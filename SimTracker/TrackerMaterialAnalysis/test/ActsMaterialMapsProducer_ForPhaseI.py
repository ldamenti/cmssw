...
process.createMaterialFile = cms.EDProducer("JsonMaterialMapsProducer",
    G4InputFile = cms.untracked.string("geant4MaterialFile.root"),
    OutputFile  = cms.untracked.string("ActsMaterialMaps.json"),
    Nevents = cms.untracked.int32(10),    # NOTE: MAX value = number of tracks of the G4 file
    ActsLogLevel    = cms.untracked.string("info")
)
