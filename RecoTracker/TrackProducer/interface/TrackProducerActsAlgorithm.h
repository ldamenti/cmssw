#ifndef TrackProducerActsAlgorithm_h
#define TrackProducerActsAlgorithm_h

/** \class TrackProducerActsAlgorithm
...
struct FitterActsCloner {
  std::unique_ptr<TrajectoryFitter> fitter;
  TkClonerImpl hitCloner;

  FitterActsCloner(const TrajectoryFitter *theFitter, const TransientTrackingRecHitBuilder *builder)
...
template <class T>
class TrackProducerActsAlgorithm : public AlgoProductTraits<T> {
public:
...
public:
  /// Constructor
  TrackProducerActsAlgorithm(const edm::ParameterSet &conf)
...
#include "RecoTracker/TrackProducer/interface/TrackProducerActsAlgorithm.icc"

template <>
bool TrackProducerActsAlgorithm<reco::Track>::buildTrack(const TrajectoryFitter *,
                                                     const Propagator *,
                                                     AlgoProductCollection &,
                                                     TransientTrackingRecHit::RecHitContainer &,
                                                     TrajectoryStateOnSurface &,
...
template <>
bool TrackProducerActsAlgorithm<reco::GsfTrack>::buildTrack(const TrajectoryFitter *,
                                                        const Propagator *,
                                                        AlgoProductCollection &,
                                                        TransientTrackingRecHit::RecHitContainer &,
                                                        TrajectoryStateOnSurface &,
