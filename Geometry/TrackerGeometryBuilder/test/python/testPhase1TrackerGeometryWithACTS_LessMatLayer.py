...
process.trackinGeoProducer = cms.ESProducer("TrackerGeomBuilderWithActsESProducer_LessMatLayers", 
    ...
    outputSvgFile  = cms.untracked.string("CMSPhase1Blueprint_lessMatLayers.svg"),
